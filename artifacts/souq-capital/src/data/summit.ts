...
// Static copy used by the GitHub Pages build when the optional API is unavailable.
// Keep this synchronized with the API route's Summit payload.
...
const summitDetails: SummitDetails = {
  header: {
